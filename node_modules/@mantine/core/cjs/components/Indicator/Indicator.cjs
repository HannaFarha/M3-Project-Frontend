...
const varsResolver = createVarsResolver.createVarsResolver(
  (theme, { color, position, offset, size, radius, zIndex, autoContrast }) => ({
    root: {
      ...
      "--indicator-text-color": autoContrast ? getContrastColor.getContrastColor({ color, theme }) : void 0,
...
const Indicator = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box.Box, { ref, ...getStyles("root"), mod: [{ inline }, mod], ...others }, !disabled && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    Box.Box,
    {
